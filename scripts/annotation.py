...
# sdata_sub = sd.bounding_box_query(
#     sdata,
#     min_coordinate=[49000, 6000],
#     max_coordinate=[58000, 16000],
#     axes=("x", "y"),
#     target_coordinate_system="Visium_HD_Human_Colon_Cancer",
#     filter_table=True,
# )
...
sdata_sub = sd.bounding_box_query(
    ...
    max_coordinate=[
        56000,
        14000,
    ],  # ~5000x5000 instead of 9000x10000
    axes=("x", "y"),
    target_coordinate_system="Visium_HD_Human_Colon_Cancer",
    filter_table=True,
)
...
sdata_sub.tables["table"].write_h5ad(
    r"C:\Users\rafae\Projects\segmentation-and-annotation\data\spatial\segmented.h5ad"
)

# Read h5ad again
sdata_sub = sd.read_h5ad(
    r"C:\Users\rafae\Projects\segmentation-and-annotation\data\spatial\segmented.h5ad"
)
